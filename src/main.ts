...
import { createCommentEffects } from './app/shared/components/comments/store/effects';
import { commentFeatureKey, commentReducer } from './app/shared/components/comments/store/reducer';
bootstrapApplication(AppComponent, {
  providers: [
    ...
    provideEffects({ createCommentEffects }, PopularTagsEffects, authEffects, streamEffects, addToFavoritesEffects),
